...
<div class="relative w-full h-full font-mono">
	...
	>
		...
		<div class="mb-4">
			<label class="text-xs text-gray-400 block mb-1" for="seed-input">Seed</label>
	...
	<canvas bind:this={canvas} class="block w-full h-full touch-none focus:outline-none bg-[#0d0d0d]"
	></canvas>
</div>
